...
def _parse_results(page, max_results: int) -> list[SearchResultItem]:
    ...
    Extract the title and URL from the contained <a> elements.
    Extract the snippet by finding texts with significant length.
    """
    ...
    for r in results:
        ...
        if snippet_el:
            ...
            for div in r.css('div') + r.css('span'):
                ...
                # Ensure the text is decently long and isn't the UI elements or the title itself
