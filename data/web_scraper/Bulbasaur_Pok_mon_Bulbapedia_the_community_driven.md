...
timestamp: "2026-04-03T22:12:03.752931+02:00"
---
...
- Unknown
- 87.5% male, 12.5% female | **Catch rate** |
| 45 (11.9%) |
| **Breeding**
...
Bulbasaur is sometimes seen seen napping in bright sunlight and can survive for days without eating. It is found in grasslands and forests throughout the Kanto region. However, due to its status as a first partner Pokémon, it is hard to come by in the wild and is generally found under the ownership of a Trainer. It has been recently seen living in the Terarium of Blueberry Academy. First partner Pokémon such as Bulbasaur are raised by Pokémon Breeders to be distributed to new Trainers.humans from birth, it is regarded as both a rare and well-behaved Pokémon. It is known to be extremely loyal, even after long-term abandonment.evolve, but if it does not want to, it struggles to resist the transformation. Many Bulbasaur gather every year in a hidden garden in Kanto to evolve into Ivysaur in a ceremony led by a Venusaur.Berries.Pokémon Sleep, Bulbasaur sits still and basks in sunny spots during its sleep, possibly trying to absorb nutrients from its seed to grow big.  
...
| Legends: Z-A | A strange seed was planted on its back at birth. The plant sprouts and grows with this Pokémon. | | | | | | | | | | | | | |
| | Spin-off games |  |  | Pokopia  
 #001 |
| --- | --- | --- | --- |
| | Pokopia | It carries a seed on its back right from birth. As its body grows larger, the seed does too. |
| --- | --- | | | | | |
...
| | X | Y |  |
| --- | --- | --- |
| Received from Professor Sycamore at the Sycamore Pokémon Lab in Lumiose City |
...
| Legends: Z-A | |  |
| **Vert District:** Pokémon Research Lab (Received from Mable during Side Mission 22)  
...
Lapis Lakeside, Greengrass IsleExpert (from Basic 1) | | | |
| | Cross-Generation |  |
| --- | --- |
| | Shuffle |  |
| --- | --- |
...
| Café ReMix |  |
| **Bulbasaur**:  
Menu Development: Complete Dugtrio Sandwich Trio recipe, Delivery.  
**Bulbasaur (Shiny)**:  
Random chance.  
**Celebratory crown**:  
Event: Bulbasaur's Happy Pokémon Day (February 2022).  
**3rd anniversary**:  
...
| Yellow | |  |
| Stadium | | Normal Box (From Round 1: 100%)  Gorgeous Box (From Round 2: 100%) |
...
| Minimum stats are calculated with 0 EVs, IVs of 0, and (if applicable) a hindering nature.Maximum stats are calculated with 252 EVs, IVs of 31, and (if applicable) a helpful nature.This Pokémon's Special base stat in Generation I was **65**. | | | |
...
Bulbasaur is available in Scarlet and Violet Version 3.0.0+ and Legends: Z-A.
...
| **Bold** indicates a move that gets STAB when used by Bulbasaur*Italic* indicates a move that gets STAB only when used by an Evolution of BulbasaurClick on the generation numbers at the top to see level-up moves from other generations | | | | | | |
...
| 3 | 6 | **Vine Whip** | Grass | Physical | 04545 | 6 |
| 6 | 9 | Growth | Grass | Status | 0000— | 15 |
| 9 | 12 | Leech Seed | Grass | Status | 0000— | 12 |
| 12 | 15 | **Razor Leaf** | Grass | Physical | 05555 | 6 |
| 15 | 18 | Poison Powder | Poison | Status | 0000— | 10 |
| 15 | 18 | Sleep Powder | Grass | Status | 0000— | 10 |
| 25 | 28 | Take Down | Normal | Physical | 09090 | 8 |
| 30 | 33 | **Magical Leaf** | Grass | Special | 06060 | 6 |
| 35 | 38 | Synthesis | Grass | Status | 0000— | 15 |
| 40 | 43 | Amnesia | Psychic | Status | 0000— | 9 |
| 42 | 45 | **Sludge Wave** | Poison | Special | 09595 | 8 |
| 45 | 48 | Double-Edge | Normal | Physical | 120120 | 10 |
| 55 | 58 | **Solar Beam** | Grass | Special | 120120 | 12 | |
| **Bold** indicates a move that gets STAB when used by Bulbasaur*Italic* indicates a move that gets STAB only when used by an Evolution of BulbasaurClick on the generation numbers at the top to see level-up moves from other generations | | | | | | |
...
| **Bold** indicates a move that gets STAB when used by Bulbasaur*Italic* indicates a move that gets STAB only when used by an Evolution or an alternate form of BulbasaurClick on the generation numbers at the top to see TM moves from other generations |
...
| TM151 | TM151 | **Petal Dance** | Grass | Special | 04040 | 10 | |
| **Bold** indicates a move that gets STAB when used by Bulbasaur*Italic* indicates a move that gets STAB only when used by an Evolution or an alternate form of BulbasaurClick on the generation numbers at the top to see TM moves from other generations |
...
| Moves marked with an asterisk (*) must be chain bred onto Bulbasaur**Bold** indicates a move that gets STAB when used by Bulbasaur*Italic* indicates a move that gets STAB only when used by an Evolution of BulbasaurClick on the generation numbers at the top to see Egg moves from other generations |
...
- **Phrases**
- 61%-100% HP I'm going to make a big flower bloom!
- 26%-60% HP I'm down to about half my HP now.
- 1%-25% HP I'm about to keel over...
- Level up I did it! My level went up!
- **Partner phrases**
- 61%-100% HP Let's try to do our best, <name>!
- 26%-60% HP This is getting a bit hard...
...
- Grass **Skill:** Auto Fix **Max Size:** 10 × 10 **Rank:** Normal
...
|  | Sometimes clears three unbreakable-block disruptions.
  | |
|  | **PSB drops:** Daily Pokémon (Weeks 4 and 16, Thursday) | | | |
| --- | | | |
| - **Pokémon GO**
...
- **Charged Attacks:** Sludge Bomb, Seed Bomb, Power Whip, Frustration, Return | | | | | |
...
- Bulbasaur **Icon**: **Specialty**: **Cookie:**
- Small plates
- **How to recruit**
- **Hearts needed:** 18 **Delivery:** 2.29% Offering Rate
- **Puzzle Abilities**
- **Puzzle score:** **Lv. 1:** 90 **Lv. 25:** 210
- **Megaphones**: **Lv. 1:** x1 / 35 links **Lv. 25:** x1 / 28 links
- **Skill Info**
- **Skill gauge:**
60 **Standard Skill**: Clears icons and gimmicks in an X pattern, then replaces surrounding icons with icons of the most common Pokémon.
- **Powered-Up Skill**: Clears more icons and gimmicks in an X pattern, then replaces surrounding icons with icons of the most common Pokémon.
- **Specialty Gimmick Info**
- **Unlocks at** **Description**
- **Lv.3** Take up to 3 to their next stage by making a combo next to them.
- **Lv.5** Take up to 2 to their next stage by making a combo next to them.
- **Lv.15** Clear up to 3 by making a combo next to them
- **Unlocks with** **Hidden Specialty Gimmick**
- **Kitchen notes** Clear up to 3 by making a combo next to them.
- **Outfit Grade Up**
...
- Celebratory crown **Icon**: **Specialty**: **Cookie:**
- Entrées
- **How to recruit**
...
- **Skill Info**
- **Skill gauge:**
60 **Standard Skill**: Clears Pokémon icons and gimmicks in an X pattern, then replaces very few surrounding icons with megaphones.
- **Powered-Up Skill**: Clears Pokémon icons and gimmicks in an X pattern, then replaces a few surrounding icons with megaphones.
- **Specialty Gimmick Info**
- **Unlocks at** **Description**
- **Lv.3** Take up to 3 to their next stage by making a combo next to them.
- **Lv.5** Take up to 2 to their next stage by making a combo next to them.
...
- **Specialty:** Ingredients **Berry:** Durin Berry ×1 **Primary ingredient:** Honey ×2
...
| --- |
| Unevolved |
| Bulbasaur Grass Poison | Level 16
→ | |
| --- |
| First Evolution |
| Ivysaur Grass Poison | Level 32
→ | |
| --- |
| Second Evolution |
| Venusaur Grass Poison |
...
In *Bulbasaur's Mysterious Garden*, a group of wild Bulbasaur gathered in the Mysterious Garden and took part in a festival where they all evolved into Ivysaur en masse. They also took Ash's Bulbasaur to the garden with them, though it refused to evolve.
...
Bulbasaur in Pokémon Concierge
...
A Bulbasaur appeared in *I'm Haru, the New Concierge!*, welcoming Haru to the Pokémon Resort. It made cameo appearances in the following episodes.
...
Bulbasaur in *POKÉMON Detective Pikachu*Bulbasaur in the music video for Celestial
...
- In the Brazilian Portuguese dub of the animated series, Bulbasaur is intentionally referred to as "Bulbassauro", despite its name still maintaining the English spelling in written media. The same is true for its evolved forms.
...
- While Bulbasaur is not considered to be part of the inspiration for the naming of *Bulbasaurus*, a genus of dicynodonts, it has been noted that the similarities "may not be entirely coincidental".

### Concept and development

Bulbasaur was designed by Atsuko Nishida.

### Origin

Bulbasaur is based on a frog.horned frogs. According to Ken Sugimori and Atsuko Nishida, the latter designed Bulbasaur working backward from Venusaur, meaning Bulbasaur was the last of its evolutionary line to have been designed and was also directly based on Venusaur.lily or onion.

#### Name origin

Bulbasaur is a combination of *bulb**dinosaur**-saurus*lizard). The name also sounds similar to the word *bulbous*.
...
| --- | --- | --- |
| Japanese | フシギダネ *Fushigidane* | From 不思議 *fushigi* (strange, mysterious) and 種 *tane* (seed), as well as a pun of 不思議だね *Fushigi, da ne?* (Isn't it strange?) |
...
| Korean | 이상해씨 *Isanghessi* | From 이상하다 *isanghada* (to be strange or abnormal) and 씨 *ssi* (seed) |
| Mandarin Chinese | 妙蛙種子 / 妙蛙种子 *Miàowāzhǒngzǐ* | From 妙 *miào* (wonderful), 蛙 *wā* (frog), and 種子 / 种子 *zhǒngzǐ* (seed) |
| Cantonese Chinese | 妙蛙種子 *Miuhwājúngjí**  
奇異種子 *Kèihyihjúngjí** | From 妙 *miuh* (wonderful), 蛙 *wā* (frog), and 種子 *júngjí* (seed)  
From 奇異 *kèihyih* (strange) and 種子 *júngjí* (seed) |
