...
- Describe what you found in your research, add supplementary information. The output should be factual, and direct without any conversational padding (Do not say "Here is what I found").
"""
